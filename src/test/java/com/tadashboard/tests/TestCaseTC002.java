...
public class TestCaseTC002 extends BaseTest{
    ...
    public void DA_LOGIN_TC002(User invalidUser) {
        ...
        Assert.assertEquals(AlertHelper.getTextAlert(), Message.LOGIN_INVALID_INFO_ERROR_MESSAGE.getValue(),
                "Dashboard Error message " + "\"" + Message.LOGIN_INVALID_INFO_ERROR_MESSAGE + "\"" + " appears");
    }
